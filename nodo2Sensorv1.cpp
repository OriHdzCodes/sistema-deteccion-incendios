...
const char mqttUserName[] = "FhAuKzMILgsbOiIWAjcIMwg";
const char clientID[] = "FhAuKzMILgsbOiIWAjcIMwg";
const char mqttPass[] = "EEVLzlKavsgnDJ04fVFunOnh";
//Canal de thingspeak al que se mandan datos
#define channelID 2733787
...
void loop() {
  ...
  if (!isnan(t)) {
    ...
    if (TempVect[14] != 0) {
      if (analogRead(sensorPin) > 3000 || (TempProm + 2) < t) {
